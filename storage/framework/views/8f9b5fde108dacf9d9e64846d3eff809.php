...
<?php $component->withAttributes([]); ?>
        ...
        <Link class="add" href="<?php echo e(route('admin.add')); ?>">Add New Admin</Link>
        <div class="wrapper" style="">
            <?php if (isset($component)) { $__componentOriginal9e290f7144d9abd075e5cf038a814133 = $component; } ?>
<?php $component = ProtoneMedia\Splade\Components\Table::resolve(['for' => $admins] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                <?php $__env->slot('spladeTableCell418c5509e2171d55b0aee5c2ea4442b5', function ($admin) use ($__env) { ?>
                    <Link href="<?php echo e(route('admin.edit',['id'=>$admin->id])); ?>" class="text-green-500"> Edit </Link>
                    <Link href="<?php echo e(route('admin.delete',['id'=>$admin->id])); ?>" method="POST" class="text-red-500 ms-2"> Delete </Link>
                <?php }); ?>
